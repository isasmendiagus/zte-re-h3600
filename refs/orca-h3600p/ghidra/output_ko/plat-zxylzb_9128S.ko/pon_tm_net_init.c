...
// function: pon_tm_net_init @ 0x1a800
// size: 320 bytes
//
...

{
  ...
  pon_tm_netdev._4_4_ = pon_tm_net_register(1,&_LC28,param_3,param_4,param_4);
  ...
  if (iVar1 != 0) {
    ...
    *(uint *)(tm_base + 0x104) = *(uint *)(tm_base + 0x104) | 7;
    upload_hook = pp_upload_fun;
    __memzero(pp_gso_bp_pool,0x1000);
