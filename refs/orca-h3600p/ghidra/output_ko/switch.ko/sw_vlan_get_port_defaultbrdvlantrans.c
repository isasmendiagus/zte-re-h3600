// module: switch.ko
// function: sw_vlan_get_port_defaultbrdvlantrans @ 0x1af9c
// size: 184 bytes
//
...

{
  ...
  if (uVar2 < _tm_port_unknwn_multicast_floodport_set) {
    iVar1 = tm_port_dft_broadcst_vltrans_get(tm_set_p2pmode[uVar2],local_14);
    if (iVar1 == 0) {
    ...
    printk("[%s]%d input port error!\n","sw_vlan_get_port_defaultbrdvlantrans",0x236);
    iVar1 = -1;
  }
  return iVar1;
}
