// module: switch.ko
// function: sw_port_get_port_linkstate @ 0x17d74
// size: 284 bytes
//
...

{
  ...
  iVar2 = zte_api_sw_port_get_port_linkstate(tm_set_p2pmode[*param_1],&local_13,&local_12,&local_11)
  ;
  if (iVar2 == 0) {
    ...
    printk("[%s] L%d tm sdk failed!\n","sw_port_get_port_linkstate",0x205);
    uVar3 = 0xffffffff;
  }
  return uVar3;
}
