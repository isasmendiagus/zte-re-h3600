// module: switch.ko
// function: pdt_ethdrv_send @ 0x10f94
// size: 972 bytes
//
...

{
  ...
  if (g_debug_mode == 7) {
    ...
    if (g_eth_debug_vlan != uVar6) goto LAB_0001101c;
LAB_00010fcc:
    uVar7 = 0;
    printk("debbug skb @:====  %s   ===\n","pdt_ethdrv_send");
    ...
    if ((g_debug_mode & 0xfd) == 1) goto LAB_00010fcc;
    if (g_debug_mode == 4) {
...
LAB_0001110c:
        ...
        if (iVar4 != 0) goto LAB_0001101c;
      }
      goto LAB_00010fcc;
    }
    if (g_debug_mode == 6) {
      iVar4 = memcmp((void *)(*(int *)(param_1 + 0xd4) + 6),&g_eth_debug_mac,6);
      if (iVar4 == 0) goto LAB_00010fcc;
    }
...
LAB_0001101c:
  *(code *)(param_1 + 0xbc) = tm_set_p2pmode[*(byte *)(param_2 + 0x4c0)];
...
LAB_00011174:
        if (_zte_api_sw_mac_set_port_learnlimit == uVar7) {
          iVar4 = dev_get_by_name(&init_net,&_LC1);
          goto joined_r0x00011198;
        }
      }
    }
    else if (wan_to_lan != 0) {
      uVar7 = (uint)*(byte *)(param_1 + 0xbc);
      if ((byte)tm_set_p2pmode[wanLogicPort] != uVar7) goto LAB_00011174;
