    ...
    do {
      while( true ) {
        ...
        if (0 < idm_net_debug) {
          ...
          dump_idm_data(*(undefined4 *)(iVar12 + 0xd4),*(undefined4 *)(iVar12 + 100));
        ...
        if (iVar5 == 0) {
          ...
          if (iVar5 != 0) {
            iVar7 = *(int *)(iVar5 + 0xd4) + 0x20;
            *(int *)(iVar5 + 0x18) = iVar14;
            iVar6 = *(int *)(iVar5 + 200) + 0x20;
          ...
          *(int *)(iVar14 + 0x4e4) = *(int *)(iVar14 + 0x4e4) + 1;
          ...
          iVar7 = *(int *)(iVar5 + 0xd4);
          iVar6 = *(int *)(iVar5 + 200);
LAB_000157b8:
          uVar3 = rx_desc;
          *(int *)(iVar5 + 200) = iVar6 + 0x20;
          *(int *)(iVar5 + 0xd4) = iVar7 + 0x20;
          *(int *)(uVar2 + uVar1 * 8) = iVar7 + -0x7fffffe0;
          *(int *)(skb_rq + ((int)(iVar13 - uVar3) >> 3) * 4) = iVar5;
          *(ushort *)(iVar5 + 0xc4) = *(ushort *)(iVar5 + 0xc4) | 0x10;
...
LAB_00015710:
        if (uVar15 == uVar11) goto LAB_000158b4;
      }
      *(int *)(iVar14 + 0x4e4) = *(int *)(iVar14 + 0x4e4) + 1;
      ...
      if (iVar12 == 0) {
        ...
        iVar5 = *(int *)(iVar12 + 0xd4) + 0x20;
        *(int *)(iVar12 + 0x18) = iVar14;
        iVar14 = *(int *)(iVar12 + 200) + 0x20;
        *(int *)(iVar12 + 0xd4) = iVar5;
        *(int *)(iVar12 + 200) = iVar14;
      }
      else {
        iVar5 = *(int *)(iVar12 + 0xd4);
        iVar14 = *(int *)(iVar12 + 200);
      }
      uVar8 = rx_desc;
      *(int *)(iVar12 + 200) = iVar14 + 0x20;
      *(int *)(iVar12 + 0xd4) = iVar5 + 0x20;
      *(int *)(uVar2 + uVar1 * 8) = iVar5 + -0x7fffffe0;
      *(int *)(skb_rq + ((int)(iVar13 - uVar8) >> 3) * 4) = iVar12;
      *(ushort *)(iVar12 + 0xc4) = *(ushort *)(iVar12 + 0xc4) | 0x10;
    } while (uVar15 != uVar11);
LAB_000158b4:
