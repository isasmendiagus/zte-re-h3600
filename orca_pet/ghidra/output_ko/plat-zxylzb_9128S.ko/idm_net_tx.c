...
LAB_00015c48:
        ...
        *(int *)(param_2 + 0x4e8) = *(int *)(param_2 + 0x4e8) + 1;
        param_1 = puVar6;
        iVar8 = local_30;
        if (puVar6 == (undefined4 *)0x0) goto LAB_00015c74;
      }
      iVar1 = tx_desc;
      uVar2 = idm_tx_index;
      ...
      if (iVar4 == 0) goto LAB_00015c48;
      iVar5 = *(int *)(param_2 + 0x4c0);
      if ((uint)param_1[0x19] < 0x21) {
        param_1[0x19] = 0x21;
      }
      *(int *)(iVar1 + uVar2 * 8) = param_1[0x35] + -0x80000000;
      iVar1 = idm_net_debug;
      *(uint *)(iVar4 + 4) =
           param_1[0x19] | *(int *)(param_2 + 0x4c4) << 0x1f |
           (uint)*(byte *)((int)param_1 + 0xbf) << 0x1c;
      if (0 < iVar1) {
        local_30 = iVar8;
        printk("send len %u,data %x,head %x\n",param_1[0x19],param_1[0x35],param_1[0x34]);
        dump_idm_desc_tx(iVar4);
        dump_idm_data(param_1[0x35],param_1[0x19]);
