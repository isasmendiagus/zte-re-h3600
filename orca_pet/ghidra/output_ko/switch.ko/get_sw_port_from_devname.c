// module: switch.ko
// function: get_sw_port_from_devname @ 0x168ac
// size: 412 bytes
//
...
LAB_000168e8:
    ...
    if (iVar2 == 0) {
      ...
      if (((int)uVar3 < 0) || (_tm_port_unknwn_multicast_floodport_set < uVar3)) goto LAB_000168e8;
      *param_2 = (uint)(byte)zte_api_fast_l3_session_del[local_20[0] >> 0x18];
      ...
      if (((iVar2 == 0) || (iVar2 = strcmp((char *)local_20,"ptm0"), iVar2 == 0)) ||
        ...
        *param_2 = _zte_api_sw_mac_set_port_learnlimit;
      }
      else {
        iVar2 = IfName2WlanIdmMap(local_20);
        if (iVar2 == 0) goto LAB_000168e8;
