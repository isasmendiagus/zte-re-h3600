// module: switch.ko
// function: sw_acl_l3_hardfast_session_add.part.1 @ 0x12444
// size: 1652 bytes
//
...

{
  ...
  if (*(char *)(param_1 + 0x14) == '\0') {
    ...
    if (*(char *)(param_1 + 0x15) != '\0') {
      ...
      if (iVar4 == 0) {
        ...
        sVar3 = 1;
        if ((iVar4 != 1) && (sVar3 = local_8e, iVar4 == 2)) {
          sVar3 = 3;
        }
      }
    }
  ...
  if (2 < g_switch_debug_level) {
    printk("uc_l2=%d, uc_l3=%d, l3Fast.l3_num=%d\n",*(char *)(param_1 + 0x14),
           *(undefined1 *)(param_1 + 0x15),local_8e);
  }
  sw_acl_setMtchInfo(param_1,local_bc);
  if (local_8e == 2) {
    if (param_1 == 0) {
    ...
    local_88 = 0;
    local_90 = (undefined1)*(undefined2 *)(param_1 + 0x52);
    if ((*(byte *)(param_1 + 0x4d) & 8) == 0) {
      if (((*(byte *)(param_1 + 0x4d) & 0xc) == 4) && (local_bc[0] == '\0')) {
        local_8a = 0xffff;
        local_90 = 0xff;
      }
      else {
      ...
      local_8c = 0xffff;
      local_8a = *(ushort *)(param_1 + 0x34) << 8 | *(ushort *)(param_1 + 0x34) >> 8;
    }
    if (g_switch_debug_level < 3) goto LAB_000125a4;
    printk("l2 len %d,  cvlan %d, svlan %d\n",local_90,local_8c,local_8a);
LAB_000126d0:
    local_d4 = 0;
...
LAB_000129f0:
    ...
    local_86 = **(undefined4 **)(param_1 + 0x28);
    local_82 = *(undefined2 *)(*(undefined4 **)(param_1 + 0x28) + 1);
    local_80 = **(undefined4 **)(param_1 + 0x24);
    local_7c = *(undefined2 *)(*(undefined4 **)(param_1 + 0x24) + 1);
    local_88 = 0;
    if (*(int *)(param_1 + 0xc) == 2) {
      uVar2 = *(undefined2 *)(param_1 + 0x52);
      local_90 = (undefined1)uVar2;
joined_r0x00012890:
      if (2 < g_switch_debug_level) {
      ...
      local_68 = *(ushort *)(param_1 + 0x2c) << 8 | *(ushort *)(param_1 + 0x2c) >> 8;
      if (2 < g_switch_debug_level) {
        printk("set nat ip:0x%08x, set nat port %d\n",local_78,local_68);
        uVar2 = *(undefined2 *)(param_1 + 0x52);
        local_90 = (undefined1)uVar2;
        goto joined_r0x00012890;
      }
      local_90 = (undefined1)*(undefined2 *)(param_1 + 0x52);
    }
    uVar6 = (uint)*(byte *)(param_1 + 0x4d);
    if ((*(byte *)(param_1 + 0x4d) & 8) == 0) {
      if (((uVar6 & 0xc) == 4) && (local_bc[0] == '\0')) {
        local_8a = 0xffff;
        local_90 = 0xff;
      }
      else {
    ...
    local_52 = *(ushort *)(param_1 + 0x2e) << 8 | *(ushort *)(param_1 + 0x2e) >> 8;
    local_54 = (byte)((uVar6 << 0x1f) >> 0x1f);
    if (2 < g_switch_debug_level) {
      printk("is ppp %d, set sessionid %d\n",uVar6 & 1,local_52);
      if (*(int *)(param_1 + 0xc) == 2) goto LAB_00012670;
      goto LAB_000126d0;
    }
    if (*(int *)(param_1 + 0xc) == 2) {
LAB_00012670:
      if (local_bc[0] == '\0') {
        local_50 = *(undefined1 *)(param_1 + 0x3c);
        puVar10 = (uint *)(*(int *)(param_1 + 0x44) + -4);
        local_4c = *(undefined4 *)(param_1 + 0x40);
        puVar9 = (uint *)(*(int *)(param_1 + 0x48) + -4);
        local_48 = *(undefined1 *)(param_1 + 0x3d);
        iVar4 = 0;
        pcVar7 = local_bc;
        do {
          puVar10 = puVar10 + 1;
...
LAB_000125a4:
  ...
  if (iVar4 != 0) {
    ...
    if (g_switch_debug_level < 2) {
      ...
      local_24 = 0;
      if ((bVar8 & 8) != 0) {
        local_20 = (byte)(uVar6 >> 0xd);
      }
    }
    else {
      local_20 = *(byte *)(param_1 + 0x51);
      if ((bVar8 & 0x10) != 0) {
        local_87 = *(undefined1 *)(param_1 + 0x4c);
        local_88 = 1;
      }
      if (2 < g_switch_debug_level) {
        printk("sip %d, gemport %d, tcont %d, q %d\n",local_b8,local_22,local_24,local_20);
      }
    }
    goto LAB_0001260c;
  }
  get_sw_port_from_devname(*(undefined4 *)(param_1 + 0x18),&local_d4);
  local_20 = *(byte *)(param_1 + 0x51);
  local_22 = (undefined2)local_d4;
...
LAB_000128d4:
    ...
    bVar8 = *(byte *)(param_1 + 0x4d);
    if ((bVar8 & 8) == 0) goto LAB_000128d4;
    uVar1 = *(ushort *)(param_1 + 0x34);
LAB_000127e4:
    local_8c = 0xffff;
    local_8a = uVar1 << 8 | uVar1 >> 8;
  }
  if ((bVar8 & 0x10) != 0) {
...
LAB_0001260c:
  iVar4 = zte_api_fast_l3_session_add(local_bc,&local_d4);
  if ((((iVar4 != 0) && (iVar5 = __printk_ratelimit("sw_acl_l3_hardfast_session_add"), iVar5 != 0))
      && (g_switch_debug_level != 0)) &&
     (iVar5 = ___ratelimit(&_rs_58249,"sw_acl_l3_hardfast_session_add"), iVar5 != 0)) {
    printk("[%s] zte_api_fast_l3_session_add failed %d\n","sw_acl_l3_hardfast_session_add",iVar4);
  }
  *(undefined4 *)(param_1 + 0x58) = local_d4;
  *(undefined4 *)(param_1 + 0x5c) = local_d0;
  *(undefined4 *)(param_1 + 0x60) = local_cc;
  *(undefined4 *)(param_1 + 100) = uStack_c8;
  *(undefined4 *)(param_1 + 0x68) = uStack_c4;
  *(undefined4 *)(param_1 + 0x6c) = uStack_c0;
  return iVar4;
}
