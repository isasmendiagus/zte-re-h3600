...

{
  ...
  if (_proc_create_data == 0) {
    uVar14 = 8000;
  }
  else {
    uVar9 = 0;
    local_e8 = tm_set_p2pmode;
    uVar15 = 0;
    do {
      if (uVar15 < _tm_port_unknwn_multicast_floodport_set) {
        uVar9 = (uint)(byte)*local_e8;
      }
      else if ((uVar15 == _tm_port_unknwn_multicast_floodport_set) && (_tm_vlan_check_ena_set != 0))
      {
        uVar9 = _zte_api_sw_mac_set_port_learnlimit & 0xff;
      }
      else if ((uVar15 == _tm_port_unknwn_multicast_floodport_set + 1) && (DAT_0002c0e6 != 0)) {
        uVar9 = (uint)(byte)tm_broadcst_vltrans_table_print_get;
      }
      else if ((uVar15 == _tm_port_unknwn_multicast_floodport_set + 2) && (DAT_0002c0ea != 0)) {
        uVar9 = (uint)(byte)zte_api_pp_set_cpu_queue_rate;
      }
      local_cb = _zte_api_sw_mac_set_port_learnlimit != uVar9;
      ...
      if (uVar9 == _zte_api_sw_mac_set_port_learnlimit) {
        uVar3 = zte_api_sw_vlan_set_port_vlancfg(uVar9,0,0xfff,3);
        uVar5 = uVar5 | uVar3;
        if (wanLogicPort != -1) {
      ...
      uVar3 = _eth_type_trans;
      if ((_tm_broadcst_vltrans_table_print_get != uVar9) &&
         (_zte_api_pp_set_cpu_queue_rate != uVar9)) {
        uVar3 = _eth_type_trans & ~(1 << uVar9);
      }
      ...
      if ((_tm_broadcst_vltrans_table_print_get == uVar9) ||
        ...
        else if ((g_switch_debug_level & 0xfffffffd) == 0) goto LAB_000139f0;
      }
      else {
LAB_000139f0:
        local_a8 = 0;
      ...
      local_e8 = local_e8 + 1;
      uVar14 = local_70;
    } while (uVar15 < _proc_create_data);
  }
  local_9f = 1;
  if ((g_switch_debug_level & 0xfffffffd) == 1) {
    local_a0 = 0;
  ...
  puVar10 = (undefined4 *)def_ptl_pkt_map_56793;
  do {
    uVar14 = *puVar10;
    puVar11 = puVar10 + 2;
    ...
    puVar10 = puVar11;
  } while (puVar11 != (undefined4 *)def_ptl_pkt_action_56798);
  if (((iVar7 != 0 || iVar8 != 0) || iVar6 != 0) || iVar2 != 0) {
    printk("zte_zx_api_pp_set_trap_queue  fails!!!!\n");
  }
  pcVar12 = def_ptl_pkt_action_56798;
  do {
