// module: switch.ko
// function: sw_multicast_en @ 0x1719c
// size: 472 bytes
//
...

{
  ...
  if (param_1 != 1) {
    ...
    uVar2 = 0;
    do {
      if ((((DAT_0002c0ea | DAT_0002c0e6) | _tm_tcont_que_sch_weight_get) & 1 << (uVar2 & 0xff)) !=
          0) {
  ...
  uVar2 = 0;
  do {
    if ((((DAT_0002c0ea | DAT_0002c0e6) | _tm_tcont_que_sch_weight_get) & 1 << (uVar2 & 0xff)) != 0)
    {
