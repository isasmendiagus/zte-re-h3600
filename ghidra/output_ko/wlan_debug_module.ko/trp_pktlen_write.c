...
// function: trp_pktlen_write @ 0x109cc
// size: 256 bytes
//

uint trp_pktlen_write(int param_1,uint param_2,uint param_3)
...
LAB_00010ab4:
  ...
  *(undefined1 *)(iVar1 + param_3) = 0;
  ...
  g_wlan_debug_trp_pktlen = simple_strtoul(iVar1,0,10);
  printk("set pktlen = [%d]\n",g_wlan_debug_trp_pktlen);
