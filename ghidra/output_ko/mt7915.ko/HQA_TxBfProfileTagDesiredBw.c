// module: mt7915.ko
// function: HQA_TxBfProfileTagDesiredBw @ 0x273438
// size: 212 bytes
//

undefined4 HQA_TxBfProfileTagDesiredBw(undefined4 param_1,undefined4 param_2,int param_3)

{
  ...
  if (local_1c[0] == (char *)0x0) {
    ...
    Set_TxBfProfileTag_DesiredBW(param_1,local_1c[0]);
    if (0 < DebugLevel) {
      printk("%s: val:%x, str:%s\n","HQA_TxBfProfileTagDesiredBw",uVar3,local_1c[0],uVar1);
    }
    uVar2 = 0;
