// module: mt7915.ko
// function: MtCmdTxPowerPercentCtrl @ 0x1bb2f0
// size: 324 bytes
//

undefined4 MtCmdTxPowerPercentCtrl(int param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  if (0 < DebugLevel) {
    printk("%s: fgTxPowerPercentEn: %d, BandIdx: %d\n","MtCmdTxPowerPercentCtrl",param_2,param_3);
  }
