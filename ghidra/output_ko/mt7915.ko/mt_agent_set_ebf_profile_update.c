// module: mt7915.ko
// function: mt_agent_set_ebf_profile_update @ 0x24e364
// size: 240 bytes
//

undefined4 mt_agent_set_ebf_profile_update(undefined4 param_1,char *param_2)

{
  ...
  if ((param_2 != (char *)0x0) && (sVar1 = strlen(param_2), sVar1 == 8)) {
    do {
      ...
      if (__s == (byte *)0x0) {
        uVar3 = mt_serv_set_ebf_profile_update(param_1,local_1c[0] & 0xff,local_1c[2] & 0xff);
        return uVar3;
      }
