// module: mt7915.ko
// function: RTMPIoctlVowGroupMinRate @ 0x36ac8
// size: 324 bytes
//

undefined4 RTMPIoctlVowGroupMinRate(undefined4 param_1,int param_2,undefined4 param_3)
...
LAB_00036b28:
      if (*local_2c == 0) {
        ...
        do {
          ...
          set_vow_min_rate(param_1,acStack_28);
          if (2 < DebugLevel) {
            printk("OID_802_11_VOW_GROUP_MIN_RATE(0x%08x) -> val %d\n",param_3,
