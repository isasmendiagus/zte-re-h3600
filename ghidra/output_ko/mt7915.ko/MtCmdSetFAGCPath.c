// module: mt7915.ko
// function: MtCmdSetFAGCPath @ 0x1b73d4
// size: 172 bytes
//

void MtCmdSetFAGCPath(int param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  if (2 < DebugLevel) {
    printk("%s, Path:%d Band:%d\n","MtCmdSetFAGCPath",param_2,param_3);
  }
