// module: mt7915.ko
// function: RcUpdateWmmEntry @ 0xabd78
// size: 212 bytes
//

int RcUpdateWmmEntry(int param_1,int param_2,undefined1 param_3)

{
  ...
  if (((param_2 != 0) && ((*(uint *)(*(int *)(param_1 + 0x18) + 0xb58) & 0x20) != 0)) &&
