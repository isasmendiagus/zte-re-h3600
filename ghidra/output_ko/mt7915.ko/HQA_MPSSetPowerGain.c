// module: mt7915.ko
// function: HQA_MPSSetPowerGain @ 0x27172c
// size: 392 bytes
//

uint HQA_MPSSetPowerGain(int param_1,undefined4 param_2,int param_3)
  ...
  if (uVar3 - 2 < 0x400) {
    ...
    if (uVar5 == 1) {
      ...
      *(char *)(param_1 + 0xa3ae36) = (char)(uVar1 >> 0x18);
      ...
      local_2c = uVar3;
      (**(code **)(iVar6 + 0xcc))(param_1,6,iVar4,local_30);
