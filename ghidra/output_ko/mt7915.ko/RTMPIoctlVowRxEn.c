// module: mt7915.ko
// function: RTMPIoctlVowRxEn @ 0x36884
// size: 256 bytes
//

undefined4 RTMPIoctlVowRxEn(undefined4 param_1,int param_2,undefined4 param_3)

{
  ...
  if (uVar5 == 0) {
    ...
    if (iVar1 == 0) goto LAB_000368e4;
  }
  else {
    if (uVar7 == 0) {
LAB_000368e4:
      sprintf(acStack_20,"%d",(uint)*local_24);
      set_vow_rx_airtime_en(param_1,acStack_20);
      if (DebugLevel < 3) {
        uVar6 = 0;
      }
      else {
        uVar6 = 0;
        printk("OID_802_11_VOW_RX_EN(0x%08x) -> val %d\n",param_3,*local_24);
      }
      goto LAB_0003691c;
    }
