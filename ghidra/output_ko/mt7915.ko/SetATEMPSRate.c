// module: mt7915.ko
// function: SetATEMPSRate @ 0x260d38
// size: 512 bytes
//

undefined4 SetATEMPSRate(int param_1,undefined4 param_2)

{
  ...
  if (iVar2 != 0) {
    ...
    if (iVar2 != 0) {
      iVar3 = os_alloc_mem(param_1,local_2c,iVar2 * 4);
      if (iVar3 == 0) {
        ...
        if (iVar3 != 0) {
          ...
          (**(code **)(iVar7 + 0xcc))(param_1,3,iVar2,local_2c[0]);
          if (local_2c[0] == 0) {
            return 1;
          }
