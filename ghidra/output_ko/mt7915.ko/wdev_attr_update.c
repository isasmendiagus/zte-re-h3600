// module: mt7915.ko
// function: wdev_attr_update @ 0x14dd30
// size: 212 bytes
//

undefined4 wdev_attr_update(undefined4 param_1,int *param_2)

{
  ...
  if (0 < DebugLevel) {
    printk("%s(): wdevId%d = %02x:%02x:%02x:%02x:%02x:%02x\n","wdev_attr_update",(char)param_2[3],
           *(undefined1 *)((int)param_2 + 0x1b),(char)param_2[7],
