// module: mt7915.ko
// function: ShowMuruUlRuStatus @ 0x23b138
// size: 236 bytes
//

bool ShowMuruUlRuStatus(undefined4 param_1)

{
  ...
  if (bVar2) {
    ...
    local_264 = CONCAT31(local_264._1_3_,8);
    AndesInitCmdMsg(iVar1,local_268,local_264,local_260,local_25c,local_258);
    AndesAppendCmdMsg(iVar1,&local_26c,4);
    AndesSendCmdMsg(param_1,iVar1);
  }
  if (3 < DebugLevel) {
    printk("%s:(Ret = %d_\n","ShowMuruUlRuStatus",bVar2);
  }
  return bVar2;
}
