// module: mt7915.ko
// function: MtCmdThermalProtectDutyInfo @ 0x1b5590
// size: 296 bytes
//

undefined4 MtCmdThermalProtectDutyInfo(undefined4 param_1,undefined4 param_2)

{
  ...
  local_38 = 0;
  if (0 < DebugLevel) {
    printk("%s: band_idx: %d\n","MtCmdThermalProtectDutyInfo",param_2);
  }
  ...
  if (3 < DebugLevel) {
    printk("%s:(ret = %d)\n","MtCmdThermalProtectDutyInfo",uVar2);
  }
  return uVar2;
}
