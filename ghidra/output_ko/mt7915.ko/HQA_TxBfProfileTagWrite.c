// module: mt7915.ko
// function: HQA_TxBfProfileTagWrite @ 0x2731b0
// size: 212 bytes
//

undefined4 HQA_TxBfProfileTagWrite(undefined4 param_1,undefined4 param_2,int param_3)

{
  ...
  if (local_1c[0] == (char *)0x0) {
    ...
    Set_TxBfProfileTagWrite(param_1,local_1c[0]);
    if (0 < DebugLevel) {
      printk("%s: val:%x, str:%s\n","HQA_TxBfProfileTagWrite",uVar3,local_1c[0],uVar1);
    }
    uVar2 = 0;
