// module: mt7915.ko
// function: Set_Fixed_UL_Ecc_Update @ 0x1dcc00
// size: 376 bytes
//

undefined4 Set_Fixed_UL_Ecc_Update(int param_1,char *param_2)

{
  ...
  if (2 < DebugLevel) {
    printk("%s():WCID = %d, ECC = %d\n","Set_Fixed_UL_Ecc_Update",local_3c,local_38);
  }
  if (iVar2 == 2) {
