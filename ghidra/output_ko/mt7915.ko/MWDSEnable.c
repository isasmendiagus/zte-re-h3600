// module: mt7915.ko
// function: MWDSEnable @ 0x9ea18
// size: 244 bytes
//

undefined4 MWDSEnable(int param_1,uint param_2,int param_3,int param_4)

{
  ...
  if (param_3 == 0) {
    if ((param_2 < 2) &&
      ...
      s__m__d_t_id__x__d__d__m_id__d__ts_00371ab0[param_1 + 1] = '\x01';
      a4_interface_init();
      return 1;
    }
  }
    ...
    if (param_2 < 0x20 && param_2 < uVar1) {
      ...
      if ("!!! Link UP, Port Not Secured! ignore this set::OID_802_11_BSSID_LIST_SCAN\n"
          [iVar2 + 0x49] == '\0') {
        "!!! Link UP, Port Not Secured! ignore this set::OID_802_11_BSSID_LIST_SCAN\n"[iVar2 + 0x49]
             = '\x01';
        a4_interface_init(param_1,param_2,1,1,iVar3);
        if (param_4 == 0) {
