// module: mt7915.ko
// function: RTMPIoctlVowBwAtEn @ 0x364fc
// size: 324 bytes
//

undefined4 RTMPIoctlVowBwAtEn(undefined4 param_1,int param_2,undefined4 param_3)
...
LAB_0003655c:
      if (*local_2c == 0) {
        ...
        do {
          ...
          set_vow_airtime_ctrl_en(param_1,acStack_28);
          if (2 < DebugLevel) {
            printk("OID_802_11_VOW_BW_AT_EN(0x%08x) -> val %d\n",param_3,
