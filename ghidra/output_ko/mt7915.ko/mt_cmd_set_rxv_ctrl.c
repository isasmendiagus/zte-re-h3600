// module: mt7915.ko
// function: mt_cmd_set_rxv_ctrl @ 0x1bee38
// size: 296 bytes
//

undefined4 mt_cmd_set_rxv_ctrl(undefined4 param_1,undefined4 param_2)

{
  ...
  local_30 = 0;
  if (0 < DebugLevel) {
    printk("%s: fgRxvEnable: %d\n","mt_cmd_set_rxv_ctrl",param_2);
  }
