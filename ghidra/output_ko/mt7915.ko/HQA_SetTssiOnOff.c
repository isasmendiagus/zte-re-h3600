// module: mt7915.ko
// function: HQA_SetTssiOnOff @ 0x26e68c
// size: 188 bytes
//

int HQA_SetTssiOnOff(int param_1,undefined4 param_2,int param_3)

{
  ...
  if (2 < DebugLevel) {
    printk(&_LC11,"HQA_SetTssiOnOff",param_3,0,0);
  }
  uVar1 = *(uint *)(param_3 + 0xc);
  pcVar4 = *(code **)(iVar3 + 0x78);
