// module: mt7915.ko
// function: pci_io_remap_read32 @ 0x17a894
// size: 272 bytes
//

void pci_io_remap_read32(undefined4 param_1,uint param_2,undefined4 param_3)

{
  ...
  if ((0xbfffff < param_2 + 0xe8000000) &&
    ...
    if (0x3fffff < param_2 + 0x84000000) {
      ...
      hif_io_read32(param_1,0xf11b0,&local_14);
      hif_io_read32(param_1,param_2 & 0xfff,param_3);
      return;
    }
  ...
  hif_io_read32(param_1,0xf11ac,&local_14);
  hif_io_read32(param_1,(param_2 & 0xffff) + 0xe0000,param_3);
  return;
}
