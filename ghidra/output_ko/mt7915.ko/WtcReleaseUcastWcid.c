// module: mt7915.ko
// function: WtcReleaseUcastWcid @ 0xadf44
// size: 248 bytes
//

uint WtcReleaseUcastWcid(int param_1,undefined4 param_2,uint param_3,undefined4 param_4)

{
  ...
  if (uVar2 <= param_3) {
    if (-1 < DebugLevel) {
      printk("%s: idx:%d > WTBL_MAX_NUM\n","WtcReleaseUcastWcid",param_3,DebugLevel,param_4);
    }
    return param_3;
  }
