// module: mt7915.ko
// function: HQA_DoCalibrationTestItem @ 0x274778
// size: 172 bytes
//

undefined4 HQA_DoCalibrationTestItem(int param_1,undefined4 param_2,int param_3)

{
  ...
  *(char *)(param_1 + 0xa3ae36) = (char)(uVar2 >> 0x18);
  MtCmdDoCalibration(param_1,1,uVar3,uVar1,uVar3,uVar1);
  if (2 < DebugLevel) {
    printk("%s, item:%x, band_idx:%x\n","HQA_DoCalibrationTestItem",uVar3,uVar1);
  }
