// module: mt7915.ko
// function: mt_cmd_set_radar_thres_param @ 0x1b9728
// size: 296 bytes
//

undefined4 mt_cmd_set_radar_thres_param(undefined4 param_1,int param_2)

{
  ...
  if (2 < DebugLevel) {
    printk("%s:(ret = %d)\n","mt_cmd_set_radar_thres_param",uVar2);
  }
  return uVar2;
}
