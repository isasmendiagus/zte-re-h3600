// module: mt7915.ko
// function: set_txcmd_dbg_muru_algo_disable @ 0x98070
// size: 248 bytes
//

undefined4 set_txcmd_dbg_muru_algo_disable(undefined4 param_1,char *param_2)
  ...
  if (iVar3 != 1) {
    ...
    *local_14[0] = *local_14[0] & 0xffc0003f | 0x1400;
    ...
    if ((pcVar4 != (char *)0x0) && (*pcVar4 != '\0')) {
      ...
      *(byte *)(puVar1 + 0xb) = (byte)puVar1[0xb] | 2;
      *(byte *)(puVar1 + 1) = (byte)puVar1[1] & 0xfd | (bVar2 & 1) << 1;
    }
    uVar5 = send_cmd_msg(param_1,local_14[0],0);
    os_free_mem(local_14[0]);
  }
  if (2 < DebugLevel) {
    printk("%s: Ret = %d\n","set_txcmd_dbg_muru_algo_disable",uVar5);
  }
  return uVar5;
}
