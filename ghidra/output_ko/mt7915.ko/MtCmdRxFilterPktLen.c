// module: mt7915.ko
// function: MtCmdRxFilterPktLen @ 0x1b6e34
// size: 184 bytes
//

void MtCmdRxFilterPktLen(int param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  if (2 < DebugLevel) {
    printk("%s, Enable:%d Band:%d RxPktLen:%d\n","MtCmdRxFilterPktLen",param_2,param_3,param_4);
  }
