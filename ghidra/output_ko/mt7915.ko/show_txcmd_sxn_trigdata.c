// module: mt7915.ko
// function: show_txcmd_sxn_trigdata @ 0x9a7c0
// size: 284 bytes
//

undefined4 show_txcmd_sxn_trigdata(undefined4 param_1,char *param_2)

{
  ...
  iVar3 = os_alloc_mem(param_1,local_14,300);
  uVar4 = 1;
  if (iVar3 != 1) {
    os_zero_mem(local_14[0],300);
    *(byte *)local_14[0] = (byte)*local_14[0] & 0xc0 | 0x13;
    *local_14[0] = *local_14[0] & 0xffc0003f | 0x4a00;
    uVar4 = send_cmd_msg(param_1,&local_18,local_14[0]);
  }
  if (2 < DebugLevel) {
    printk("%s: Ret = %d\n","show_txcmd_sxn_trigdata",uVar4);
  }
  return uVar4;
}
