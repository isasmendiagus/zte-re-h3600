// module: mt7915.ko
// function: Set_CountryRegionABand_Proc @ 0xd81b8
// size: 284 bytes
//

undefined4
Set_CountryRegionABand_Proc(int *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  if ((iVar3 - 0x100U & 0xfffffeff) == 0) {
    ...
    if ((iVar3 != 0x400) && (iVar3 != 0x800)) {
      ...
      printk("[Set_CountryRegionABand_Proc]: pObj->ioctl_if_type = %d!!\n",iVar3,iVar3,DebugLevel,
             param_4);
      return 0;
    }
    iVar3 = (uVar4 & 0xff) * 0x84dec + 0xdb6d6;
  }
  iVar1 = RT_CfgSetCountryRegion(param_1,param_2,1);
  if (iVar1 == 0) {
    return 0;
  }
  ...
  if (2 < DebugLevel) {
    printk("Set_CountryRegionABand_Proc::(CountryRegion=%d)\n",
