// module: mt7915.ko
// function: RTMPIoctlVowBwTputEn @ 0x36640
// size: 324 bytes
//

undefined4 RTMPIoctlVowBwTputEn(undefined4 param_1,int param_2,undefined4 param_3)
...
LAB_000366a0:
      if (*local_2c == 0) {
        ...
        do {
          ...
          set_vow_bw_ctrl_en(param_1,acStack_28);
          if (2 < DebugLevel) {
            printk("OID_802_11_VOW_BW_TPUT_EN(0x%08x) -> val %d\n",param_3,
