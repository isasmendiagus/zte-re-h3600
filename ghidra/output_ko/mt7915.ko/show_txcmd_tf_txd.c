// module: mt7915.ko
// function: show_txcmd_tf_txd @ 0x9ab20
// size: 284 bytes
//

undefined4 show_txcmd_tf_txd(undefined4 param_1,char *param_2)

{
  ...
  local_18 = CONCAT31(local_18._1_3_,0x14);
