// module: mt7915.ko
// function: hqa_wifi_test_mu_set_enable @ 0x90fb8
// size: 312 bytes
//

undefined4 hqa_wifi_test_mu_set_enable(undefined4 param_1,undefined4 param_2)

{
  ...
  local_1c = 0;
  if (0 < DebugLevel) {
    printk("%s: param.fgIsEnable:%d\n","hqa_wifi_test_mu_set_enable",param_2);
  }
  ...
  if (0 < DebugLevel) {
    printk("%s: Ret=%d\n","hqa_wifi_test_mu_set_enable",uVar2);
  }
  return uVar2;
}
