// module: mt7915.ko
// function: CmdTxBfApClientCluster @ 0x1b1378
// size: 304 bytes
//

undefined4 CmdTxBfApClientCluster(undefined4 param_1,int param_2,undefined4 param_3)

{
  ...
  local_3c = 0;
  if (2 < DebugLevel) {
    printk("%s: WlanIdx = %d, ucPfmuIdx = %d\n","CmdTxBfApClientCluster",param_2,param_3);
  }
