// module: mt7915.ko
// function: MtCmdTxPowerDropCtrl @ 0x1bb438
// size: 324 bytes
//

undefined4 MtCmdTxPowerDropCtrl(int param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  local_38 = 0;
  if (2 < DebugLevel) {
    printk("%s: cPowerDropLevel: %d, BandIdx: %d\n","MtCmdTxPowerDropCtrl",param_2,param_3);
  }
