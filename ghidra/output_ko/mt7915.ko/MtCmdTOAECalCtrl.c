// module: mt7915.ko
// function: MtCmdTOAECalCtrl @ 0x1bbbd4
// size: 288 bytes
//

undefined4 MtCmdTOAECalCtrl(undefined4 param_1,undefined4 param_2)

{
  ...
  if (iVar1 == 0) {
    ...
    local_40 = CONCAT13(0x6d,CONCAT12(0xed,(undefined2)local_40));
