// module: mt7915.ko
// function: Set_BAOriTearDown_Proc @ 0xdd704
// size: 708 bytes
//

undefined4 Set_BAOriTearDown_Proc(int param_1,char *param_2)

{
    ...
    if ((pcVar4 != (char *)0x0) && (sVar3 = strlen(pcVar4), 1 < sVar3)) {
      ...
      if (bVar1 < 8) {
        *pcVar4 = '\0';
        ...
        if (uVar2 < 0x80) {
          if (0 < DebugLevel) {
            printk("tear down ori ba,wcid=%d,tid=%d\n\r",uVar2,bVar1);
          }
          ba_ori_session_tear_down(param_1,uVar2,bVar1,0);
          return 1;
        }
        if (0 < DebugLevel) {
  ...
  *pcVar4 = '\0';
  ...
  if (*(char *)(param_1 + 0x286285) == '\x01') {
    ...
    if (*(char *)(param_1 + 0x286285) != '\0') goto LAB_000dd93c;
  }
...
LAB_000dd93c:
  if (iVar6 != 0) {
    ...
    ba_ori_session_tear_down(param_1,*(undefined2 *)(iVar6 + 0xe0),bVar1,0);
  }
  return 1;
}
