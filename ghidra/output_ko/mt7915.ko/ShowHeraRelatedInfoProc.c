// module: mt7915.ko
// function: ShowHeraRelatedInfoProc @ 0x1bf30c
// size: 500 bytes
//

undefined4 ShowHeraRelatedInfoProc(undefined4 param_1,char *param_2)

{
  ...
  if ((((pcVar2 != (char *)0x0) && (pcVar3 = strsep(&local_44,"-"), pcVar3 != (char *)0x0)) &&
    ...
    uStack_36 = uVar1;
    if ((3 < DebugLevel) && (printk(&_LC0,"ShowHeraRelatedInfoProc"), 3 < DebugLevel)) {
      printk("Para1: %d Para2: %d Para3: %d Para4: %d\n",local_3c & 0xffff,local_3c._2_2_,local_38,
             uStack_36);
    }
