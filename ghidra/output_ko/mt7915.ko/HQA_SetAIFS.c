// module: mt7915.ko
// function: HQA_SetAIFS @ 0x26e340
// size: 180 bytes
//

bool HQA_SetAIFS(int param_1,undefined4 param_2,int param_3)

{
  ...
  if (2 < DebugLevel) {
    printk("%s: SlotTime:%d, SifsTime:%d\n","HQA_SetAIFS",uVar4,uVar1);
  }
  pcVar3 = *(code **)(iVar5 + 0x6c);
