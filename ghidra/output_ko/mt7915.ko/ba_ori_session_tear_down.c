// module: mt7915.ko
// function: ba_ori_session_tear_down @ 0xa6bd0
// size: 272 bytes
//

void ba_ori_session_tear_down(int param_1,uint param_2,undefined4 param_3,int param_4)

{
  ...
  if (((param_2 < uVar1) && (iVar2 = ba_resrc_ori_del(param_1,param_2,param_3), iVar2 != 0)) &&
     (param_4 == 0)) {
