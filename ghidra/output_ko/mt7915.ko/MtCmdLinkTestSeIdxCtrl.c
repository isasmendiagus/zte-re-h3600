// module: mt7915.ko
// function: MtCmdLinkTestSeIdxCtrl @ 0x1bdc24
// size: 296 bytes
//

undefined4 MtCmdLinkTestSeIdxCtrl(undefined4 param_1,undefined4 param_2)

{
  ...
  local_30 = 0;
  if (2 < DebugLevel) {
    printk("%s: fgSeIdxConfigEn = %d\n","MtCmdLinkTestSeIdxCtrl",param_2);
  }
