// module: mt7915.ko
// function: hqa_wifi_test_mu_get_lq @ 0x90160
// size: 364 bytes
//

undefined4 hqa_wifi_test_mu_get_lq(undefined4 param_1,int param_2)

{
  ...
  if (param_2 == 0) {
    ...
    if (0 < DebugLevel) {
      printk("%s: pOutput = %p\n","hqa_wifi_test_mu_get_lq",param_2);
    }
    ...
    if (iVar1 == 0) {
      ...
      local_28 = CONCAT22(0x54,(undefined2)local_28);
      uVar2 = 0;
      local_20 = param_2;
