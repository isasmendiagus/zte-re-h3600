// module: mt7915.ko
// function: MtCmdLinkTestRcpiCtrl @ 0x1bdaf8
// size: 296 bytes
//

undefined4 MtCmdLinkTestRcpiCtrl(undefined4 param_1,undefined4 param_2)

{
  ...
  local_30 = 0;
  if (2 < DebugLevel) {
    printk("%s: fgRCPIConfigEn = %d\n","MtCmdLinkTestRcpiCtrl",param_2);
  }
