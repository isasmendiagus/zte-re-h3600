// module: mt7915.ko
// function: RTMPIoctlVowGroupMinRatio @ 0x36d50
// size: 324 bytes
//

undefined4 RTMPIoctlVowGroupMinRatio(undefined4 param_1,int param_2,undefined4 param_3)
...
LAB_00036db0:
      if (*local_2c == 0) {
        ...
        do {
          ...
          set_vow_min_ratio(param_1,acStack_28);
          if (2 < DebugLevel) {
            printk("OID_802_11_VOW_GROUP_MIN_RATIO(0x%08x) -> val %d\n",param_3,
