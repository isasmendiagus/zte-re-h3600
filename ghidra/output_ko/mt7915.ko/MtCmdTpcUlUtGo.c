// module: mt7915.ko
// function: MtCmdTpcUlUtGo @ 0x1bb1c0
// size: 300 bytes
//

undefined4 MtCmdTpcUlUtGo(undefined4 param_1,undefined4 param_2)

{
  ...
  local_38 = 0;
  if (-1 < DebugLevel) {
    printk("%s: fgTpcUtGo: %d \n","MtCmdTpcUlUtGo",param_2);
  }
  ...
  if (iVar1 == 0) {
    ...
    local_4c = CONCAT31(CONCAT21(local_4c._2_2_,(char)param_2),10);
    local_34 = local_48;
    uStack_30 = local_44;
    uStack_2c = local_40;
    uStack_28 = local_3c;
