// module: mt7915.ko
// function: MtCmdThermalProtectInfo @ 0x1b5464
// size: 296 bytes
//

undefined4 MtCmdThermalProtectInfo(undefined4 param_1,undefined4 param_2)

{
  ...
  local_38 = 0;
  if (0 < DebugLevel) {
    printk("%s: band_idx: %d\n","MtCmdThermalProtectInfo",param_2);
  }
