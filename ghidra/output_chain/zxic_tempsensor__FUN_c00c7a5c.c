...
// function: FUN_c00c7a5c @ 0xc00c7a5c
// found via struct field ptr -> 0xc00c7a5c
// total struct-refs for compat: 4
//

undefined8 FUN_c00c7a5c(int param_1,undefined4 param_2,uint param_3,int param_4,int param_5)
    ...
    if (-1 < param_4) {
      if (*(int *)(iVar4 + 0x24) == param_4 && *(uint *)(iVar4 + 0x20) == param_3) {
        ...
        *(int *)(param_1 + 0x44) = param_4;
        ...
        do {
          uVar2 = FUN_c00c7880(iVar4,iVar3,param_3,param_4);
