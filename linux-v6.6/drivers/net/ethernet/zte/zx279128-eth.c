...
/* Static replay tables — captured from stock, regenerated by scripts in
 * tasks/00.01.eth-driver/scripts/. Replace the old firmware-load path
 * (cla.bin / pm.bin / stock.bin / fpga.bin) entirely. */
