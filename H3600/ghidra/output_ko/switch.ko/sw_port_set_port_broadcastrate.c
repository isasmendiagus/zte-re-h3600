// module: switch.ko
// function: sw_port_set_port_broadcastrate @ 0x19af8
// size: 236 bytes
//
...

{
  ...
  if (2 < g_switch_debug_level) {
    printk("[%s] input:\n%s = %d\n%s = %d\n%s = %d\n%s = %dkbps\n%s = %d\n",
           "sw_port_set_port_broadcastrate","RateLimit.port",cVar1,"RateLimit.direct",(char)iVar4,
  ...
  uVar5 = 0;
  if (iVar4 != 0) {
    printk("[%s] L%d tm sdk failed!\n","sw_port_set_port_broadcastrate",0x77);
    uVar5 = 0xffffffff;
  }
  return uVar5;
}
