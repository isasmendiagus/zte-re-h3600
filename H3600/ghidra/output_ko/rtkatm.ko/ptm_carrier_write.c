// module: rtkatm.ko
// function: ptm_carrier_write @ 0x10654
// size: 340 bytes
//

uint ptm_carrier_write(undefined4 param_1,uint param_2,uint param_3)
...
LAB_000106b0:
        ...
        (&cStack_19)[sVar1] = '\0';
        iVar2 = dev_get_by_name(&init_net,&_LC14);
        if (iVar2 == 0) {
          local_20 = "ERROR: Cannot find the net device\n";
          local_28 = 4;
          local_24 = iVar2;
          ProcKernLog("/home/ws/zx279128s/chip_zx279128s/kmodule/rtk_atm/rtk_atm.c",0x27d,
                      "ptm_carrier_write",0);
          param_3 = 0xffffffed;
        }
        else {
