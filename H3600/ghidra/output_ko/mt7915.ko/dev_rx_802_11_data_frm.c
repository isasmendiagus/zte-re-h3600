// module: mt7915.ko
// function: dev_rx_802_11_data_frm @ 0xcca3c
// size: 208 bytes
//

void dev_rx_802_11_data_frm(int param_1,int param_2)

{
  ...
  iVar1 = FUN_000c5084();
  if (iVar1 == 0) {
    wlan_dbg_set_last_error(0,1,0x1b54,"dev_rx_802_11_data_frm");
  }
  else {
    iVar1 = (**(code **)(*(int *)(*(int *)(iVar1 + 8) + 0x904) + 0x6c))
