// module: mt7915.ko
// function: mt_op_evt_rf_test_cb @ 0x258718
// size: 4 bytes
//

int mt_op_evt_rf_test_cb
...

{
  ...
  case 1:
    ...
    if (((*(uint *)("Get_RBIST_IQ_Data_Proc" + iVar3 + 0xc) & 0xffff) == 0x7915) &&
       (iVar6 = sys_ad_alloc_mem(&pvStack_40,6000), iVar6 != 0)) {
...
LAB_0025e87c:
          ...
          do {
            puVar9 = puVar8 + 1;
            uStack_30 = *puVar8;
            *(undefined4 *)((int)pvStack_40 + ((int)puVar8 - (int)puVar12)) = uStack_30;
            puVar8 = puVar9;
      ...
      if ("RTMPSetSTAPassPhrase"[iVar3 + 3] != '\0') {
        if (iVar4 == 0x20000000) {
          ...
          memcpy((void *)(*(int *)("RTMPSetSTAPassPhrase" + iVar3 + 8) +
                         *(int *)("RTMPSetSTAPassPhrase" + iVar3 + 0xc)),pvStack_40,sVar11);
          ...
          **(undefined4 **)("RTMPSetSTAPassPhrase" + iVar3 + 4) =
          ...
          memcpy((void *)(*(int *)("RTMPSetSTAPassPhrase" + iVar3 + 0x10) +
                         *(int *)("RTMPSetSTAPassPhrase" + iVar3 + 0x14)),pvStack_40,sVar11);
...
LAB_0025e700:
      ...
      do {
        uVar7 = *puVar12;
        uVar2 = uVar7;
        if (((uVar10 & 1) != 0) && (uVar2 = uStack_34, uStack_30 = uVar7, (param_3 & 8) != 0)) {
          net_ad_insert_test_log(param_1,param_2 + 0x30,&uStack_3c,8,0x10);
          uVar2 = uStack_34;
        }
        uStack_34 = uVar2;
        uVar10 = uVar10 + 1;
...
LAB_0025e5dc:
      if (iVar4 == 0x8000000) {
        ...
        memcpy((void *)(*(int *)("SetPartProfileParameters" + iVar3 + 4) +
                       *(int *)("SetPartProfileParameters" + iVar3)),pvStack_40,sVar11);
        *(size_t *)("SetPartProfileParameters" + iVar3) =
        ...
        memcpy((void *)(*(int *)("SetPartProfileParameters" + iVar3 + 0xc) +
                       *(int *)("SetPartProfileParameters" + iVar3 + 8)),pvStack_40,sVar11);
  ...
  case 10:
    if ((param_3 & 4) != 0) {
      ...
      if (uVar1 != 0) {
        ...
        do {
          puVar8 = puVar12 + 2;
          sys_ad_move_mem((void *)((int)&uStack_34 + 1),puVar12,8);
          net_ad_insert_test_log(param_1,param_2 + 0x18,&uStack_3c,4,0x14);
