// module: mt7915.ko
// function: MtCmdTpcManCtrl @ 0x1ba880
// size: 312 bytes
//

undefined4 MtCmdTpcManCtrl(undefined4 param_1,int param_2)

{
  ...
  local_38 = 0;
  if (-1 < DebugLevel) {
    printk("%s: fgTpcManual: %d \n","MtCmdTpcManCtrl",param_2);
  }
