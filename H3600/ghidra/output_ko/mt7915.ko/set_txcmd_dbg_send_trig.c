// module: mt7915.ko
// function: set_txcmd_dbg_send_trig @ 0x98364
// size: 248 bytes
//

undefined4 set_txcmd_dbg_send_trig(undefined4 param_1,char *param_2)
  ...
  if (iVar3 != 1) {
    ...
    *local_14[0] = *local_14[0] & 0xffc0003f | 0x1400;
    ...
    if ((pcVar4 != (char *)0x0) && (*pcVar4 != '\0')) {
      ...
      *(byte *)(puVar1 + 0xb) = (byte)puVar1[0xb] | 0x10;
      *(byte *)(puVar1 + 1) = (byte)puVar1[1] & 0xef | (bVar2 & 1) << 4;
    }
    uVar5 = send_cmd_msg(param_1,local_14[0],0);
    os_free_mem(local_14[0]);
  }
  if (2 < DebugLevel) {
    printk("%s: Ret = %d\n","set_txcmd_dbg_send_trig",uVar5);
  }
  return uVar5;
}
