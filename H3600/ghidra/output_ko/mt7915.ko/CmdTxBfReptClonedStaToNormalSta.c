// module: mt7915.ko
// function: CmdTxBfReptClonedStaToNormalSta @ 0x1b14ac
// size: 304 bytes
//

undefined4 CmdTxBfReptClonedStaToNormalSta(undefined4 param_1,int param_2,undefined4 param_3)

{
  ...
  local_3c = 0;
  if (2 < DebugLevel) {
    printk("%s: WlanIdx = %d, ucCliIdx = %d\n","CmdTxBfReptClonedStaToNormalSta",param_2,param_3);
  }
  ...
  if (iVar1 == 0) {
    ...
    local_4b = (byte)((uint)(param_2 << 0x16) >> 0x1e);
    local_4c = 0x15;
  ...
  if (2 < DebugLevel) {
    printk("%s:(ret = %d)\n","CmdTxBfReptClonedStaToNormalSta",uVar2);
  }
  return uVar2;
}
