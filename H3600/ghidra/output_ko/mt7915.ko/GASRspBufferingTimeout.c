// module: mt7915.ko
// function: GASRspBufferingTimeout @ 0x22c6ec
// size: 428 bytes
//

void GASRspBufferingTimeout(undefined4 param_1,int *param_2)

{
  ...
  if (2 < DebugLevel) {
    printk(&_LC1,"GASRspBufferingTimeout");
  }
  if (param_2 == (int *)0x0) {
    if (0 < DebugLevel) {
      printk("%s: GASPeerEntry is NULL\n","GASRspBufferingTimeout");
    }
  }
  else {
    iVar5 = param_2[6];
    if ((*(uint *)(iVar5 + 0xa39f84) & 0x140) == 0) {
