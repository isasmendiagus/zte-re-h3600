// module: mt7915.ko
// function: MtCmdTpcManTblInfo @ 0x1baf54
// size: 300 bytes
//

undefined4 MtCmdTpcManTblInfo(undefined4 param_1,undefined4 param_2)

{
  ...
  if (iVar1 == 0) {
    ...
    local_4c = CONCAT31(CONCAT21(local_4c._2_2_,(char)param_2),7);
    local_34 = local_48;
    uStack_30 = local_44;
    uStack_2c = local_40;
    uStack_28 = local_3c;
