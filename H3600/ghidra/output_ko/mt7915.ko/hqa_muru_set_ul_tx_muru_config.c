// module: mt7915.ko
// function: hqa_muru_set_ul_tx_muru_config @ 0x23eea4
// size: 532 bytes
//

undefined4
hqa_muru_set_ul_tx_muru_config(int param_1,char *param_2,undefined4 param_3,undefined4 param_4)
  ...
  if (*param_2 != '\0') {
    ...
    if (uVar1 == 0) {
      ...
      if (*(int *)(param_1 + 0x7959b8) != 0) {
        DAT_005f5a44 = (sbyte)*(int *)(param_1 + 0x7959b8);
      ...
      if (iVar2 == 0) {
        if (DAT_005f591c == 0) {
          ...
          printk("%s:cmd=update, target_updated_user_bmp=0x%x, not_yet_updated_user_bmp:0x%x\n",
                 "hqa_muru_set_ul_tx_muru_config",(1 << DAT_005f5a44) + -1,DAT_005f591c,param_4);
        }
        goto LAB_0023ef80;
      }
      ...
      if (puVar3 != (undefined1 *)0x0) {
        *puVar3 = 0;
        if ((puVar3 + 1 != (undefined1 *)0x0 && *param_2 != '\0') && (puVar3[1] != '\0')) {
          uVar4 = hqa_muru_parse_cmd_param_ultx(param_1,param_2,puVar3 + 1,&DAT_005f5920);
          goto LAB_0023ef80;
        }
      }
    }
...
LAB_0023ef80:
  if (0 < DebugLevel) {
    printk("%s: cmd sub-group = %s, Ret = %d\n","hqa_muru_set_ul_tx_muru_config",param_2,uVar4,
           param_4);
  }
  return uVar4;
}
