// module: mt7915.ko
// function: Set_BndStrg_HoldTime @ 0x9c1f0
// size: 188 bytes
//

undefined4 Set_BndStrg_HoldTime(int *param_1,undefined4 param_2)

{
  ...
  if (0 < DebugLevel) {
    printk("%s band %u\n","Set_BndStrg_HoldTime",uVar2);
  }
  if (uVar2 < 2) {
    if (param_1[uVar2 * 0x425 + 0xdb24f] != 0) {
      (**(code **)(param_1[uVar2 * 0x425 + 0xdb24f] + 0x38))
