// module: mt7915.ko
// function: Set_VLANID_Proc @ 0x2be78
// size: 304 bytes
//

undefined4 Set_VLANID_Proc(int *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  if (uVar1 < 0x1000) {
    ...
    if (piVar6 != (int *)0x0) {
      *(ushort *)((int)piVar6 + 0x8fa) = uVar1;
      if (*(char *)(iVar2 + 0x228) == '\0') {
        uVar3 = HcGetBandByWdev(piVar6);
        asic_update_vlan_id(param_1,uVar3,*(undefined1 *)((int)piVar6 + 0x29),uVar1,param_4);
        return 1;
      }
      return 1;
    }
