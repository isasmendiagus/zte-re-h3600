// module: mt7915.ko
// function: MtCmdLinkTestTxPwrCtrl @ 0x1bd6f0
// size: 312 bytes
//

undefined4
MtCmdLinkTestTxPwrCtrl(undefined4 param_1,undefined4 param_2,undefined1 param_3,undefined1 param_4)

{
  ...
  local_38 = 0;
  if (2 < DebugLevel) {
    printk("%s: fgTxPwrConfigEn = %d\n","MtCmdLinkTestTxPwrCtrl",param_2);
  }
