// module: mt7915.ko
// function: MtCmdThermalTaskCtrl @ 0x1bc700
// size: 328 bytes
//

undefined4
MtCmdThermalTaskCtrl
...

{
  ...
  if (iVar1 == 0) {
    ...
    local_50 = CONCAT13(0x2c,CONCAT12(0xed,(undefined2)local_50));
    local_4c = CONCAT31(local_4c._1_3_,8);
    local_4c = CONCAT22(0xffff,(undefined2)local_4c);
    local_56 = (undefined1)param_4;
