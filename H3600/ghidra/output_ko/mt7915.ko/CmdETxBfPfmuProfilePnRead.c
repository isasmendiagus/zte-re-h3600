// module: mt7915.ko
// function: CmdETxBfPfmuProfilePnRead @ 0x1b2d0c
// size: 416 bytes
//

undefined4 CmdETxBfPfmuProfilePnRead(int *param_1,undefined4 param_2)

{
  ...
  if (iVar2 == 0) {
    ...
    local_4a = (undefined1)uVar1;
    if (2 < DebugLevel) {
      printk("%s: PFMU ID = %d, Band:%d\n","CmdETxBfPfmuProfilePnRead",param_2,uVar1);
    }
    ...
    local_40 = CONCAT22(local_40._2_2_,500);
    local_34 = local_48;
    uStack_30 = local_44;
    uStack_2c = local_40;
    uStack_28 = local_3c;
  ...
  if (2 < DebugLevel) {
    printk("%s:(ret = %d)\n","CmdETxBfPfmuProfilePnRead",uVar3);
  }
  return uVar3;
}
