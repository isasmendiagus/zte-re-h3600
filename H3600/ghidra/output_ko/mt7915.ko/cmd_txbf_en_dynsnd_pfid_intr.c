// module: mt7915.ko
// function: cmd_txbf_en_dynsnd_pfid_intr @ 0x1b3fe4
// size: 296 bytes
//

undefined4 cmd_txbf_en_dynsnd_pfid_intr(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  local_38 = 0;
  if (-1 < DebugLevel) {
    printk("%s: mu_intr_en = %d, pfid = %d\n","cmd_txbf_en_dynsnd_pfid_intr",param_2,param_3);
  }
  ...
  if (-1 < DebugLevel) {
    printk("%s:(ret = %d)\n","cmd_txbf_en_dynsnd_pfid_intr",uVar2);
  }
  return uVar2;
}
