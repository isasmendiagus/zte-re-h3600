// module: mt7915.ko
// function: set_fw_cmd @ 0xbcc4c
// size: 416 bytes
//

undefined4 set_fw_cmd(undefined4 param_1,undefined4 param_2)

{
  ...
  if (uVar1 == 0) {
    if (DebugLevel < 1) goto LAB_000bcd28;
...
LAB_000bcd28:
  uVar4 = MtCmdSendRaw(param_1,local_1d,local_1c,uVar1,1);
