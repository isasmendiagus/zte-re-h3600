// module: mt7915.ko
// function: MtCmdMuPwrCtrl @ 0x1bbcf8
// size: 336 bytes
//

undefined4 MtCmdMuPwrCtrl(int param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  if (0 < DebugLevel) {
    printk("%s: u1BandIdx: %d, fgMuTxPwrManEn: %d, cMuTxPwr: %d\n","MtCmdMuPwrCtrl",param_4,param_2,
           param_3);
  }
