// module: mt7915.ko
// function: CmdPfmuMemAllocMapRead @ 0x1b20dc
// size: 232 bytes
//

undefined4 CmdPfmuMemAllocMapRead(undefined4 param_1)

{
  ...
  local_34 = 0;
  local_30 = 0;
  iVar1 = AndesAllocCmdMsg(param_1,1);
  if (iVar1 == 0) {
    uVar2 = 3;
  }
  else {
