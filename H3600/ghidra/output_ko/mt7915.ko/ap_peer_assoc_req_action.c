// module: mt7915.ko
// function: ap_peer_assoc_req_action @ 0x5172c
// size: 10276 bytes
//

/* WARNING: Removing unreachable block (ram,0x0004f374) */
/* WARNING: Removing unreachable block (ram,0x0004f390) */
/* WARNING: Removing unreachable block (ram,0x0004f394) */
/* WARNING: Removing unreachable block (ram,0x0004f398) */
/* WARNING: Removing unreachable block (ram,0x0004f39c) */
/* WARNING: Removing unreachable block (ram,0x0004f3a0) */
/* WARNING: Removing unreachable block (ram,0x0004f3a4) */
/* WARNING: Removing unreachable block (ram,0x0004f3a8) */
/* WARNING: Removing unreachable block (ram,0x0004f854) */

void ap_peer_assoc_req_action(int param_1,int param_2)
...
LAB_0004efb4:
    ...
    if (local_104 == 0) goto LAB_0004efc8;
  }
  else {
    os_alloc_mem(0,&local_100,0x310);
    ...
    __memzero(local_100,0x310);
    puVar32 = local_100;
    iVar25 = FUN_0004e3dc(param_1,0,param_2,*(undefined4 *)(param_2 + 0x908),local_100);
    if (iVar25 == 0) {
      iVar25 = 0;
      puVar32 = local_100;
      goto LAB_0004efb4;
    }
    iVar25 = MacTableLookup(param_1,local_100 + 6);
    if (iVar25 == 0) {
      puVar32 = local_100;
      if (-1 < DebugLevel) {
        printk("NoAuth MAC - %02x:%02x:%02x:%02x:%02x:%02x\n",local_100[6],local_100[7],local_100[8]
               ,local_100[9],local_100[10],local_100[0xb]);
        puVar32 = local_100;
      }
      goto LAB_0004efb4;
    }
    ...
    iVar10 = wdev_search_by_address(param_1,local_100);
    if (iVar10 == 0) {
      puVar32 = local_100;
      if (-1 < DebugLevel) {
        printk("Wrong Addr1 - %02x:%02x:%02x:%02x:%02x:%02x\n",*local_100,local_100[1],local_100[2],
               local_100[3],local_100[4],local_100[5]);
        puVar32 = local_100;
      }
      goto LAB_0004efb4;
    }
    ...
    local_d8._0_2_ = sVar1;
    local_dc._0_3_ = CONCAT12(*(undefined1 *)(iVar10 + 0x1a),(undefined2)local_dc);
    local_dc = CONCAT31(local_dc._1_3_,1);
    local_d0 = iVar10;
...
LAB_0004f364:
      ...
      bVar20 = local_158[1] & 0x7f;
      if ((bVar20 - 2 & 0xfd) == 0 || (bVar20 == 0x16 || bVar20 == 0xb)) {
        pbVar19 = local_158 + 1;
        do {
          if (pbVar19 == local_158 + (byte)(*local_158 - 1) + 1) goto LAB_0004f364;
          pbVar19 = pbVar19 + 1;
          bVar20 = *pbVar19 & 0x7f;
    ...
    memmove((void *)(iVar25 + 0x11f4),(void *)(param_2 + 0x18),__n);
    *(size_t *)(iVar25 + 0x12f4) = __n;
    ...
    if ((*(char *)(param_1 + uVar27 * 0x620 + 0x2f762) == '\x01') &&
      ...
      if ((*(short *)(iVar25 + 0xf8) != 0) &&
        ...
        *(undefined1 *)(iVar25 + 0x515) = 0;
        ...
        local_b0[0] = 1;
        local_a4 = *(undefined2 *)(iVar25 + 0xe0);
      ...
      *(undefined1 *)(iVar25 + 0xd24) = local_100[0x193];
      if ((*(char *)(iVar10 + 0x3e15) == '\0') || (*(char *)(iVar10 + 0x3e14) != '\0')) {
        if (*(byte *)(iVar25 + 0xe4) <
          ...
          if (iVar15 == 0) {
            ...
            RTMPCancelTimer(iVar10 + 0x3ab0,local_b0);
      ...
      if ((((*(char *)(iVar25 + 0xd24) == '\0') ||
        ...
        if (iVar15 == 0) {
          ...
          iVar15 = ApCheckMapBlackList(param_1,local_100 + 6,*(undefined1 *)(iVar25 + 0xe4));
          bVar3 = iVar15 == 0;
        }
      }
      else {
      ...
      if (2 < DebugLevel) {
        printk("%s - MBSS(%d), receive %s request from %02x:%02x:%02x:%02x:%02x:%02x\n","ASSOC",
               *(undefined1 *)(iVar25 + 0xe4),"ASSOC",local_100[6],local_100[7],local_100[8],
               local_100[9],local_100[10],local_100[0xb]);
      }
      __ZTE_STA_Assoc_Process(param_1,3,0,0,0,0,iVar25,"ap_cmm_peer_assoc_req_action",0x754);
      local_f4 = auStack_ec;
      SupportRate(local_158,&local_f4,&local_10a,&local_10c);
      *(undefined1 *)(iVar25 + 0xb7c) = local_10a;
      uVar9 = (byte)local_100[0x240] & 4;
      RTMPSetSupportMCS(param_1,1,iVar25,local_158,uVar9,local_100 + 0x2a4,local_100 + 0x274,
                        (byte)local_100[0x240] & 1);
      puVar32 = local_100;
      uVar21 = (uint)*(byte *)(iVar25 + 0xe4);
      uVar16 = dot11_2_ra_rate(local_10c);
      uVar8 = *(ushort *)
               (
               "======== Badnode detector =============\nvow_bn_en = <0/1> 0:dieable, 1:enable\nvow_bn_mon_period = <period> ms\nvow_bn_fallback_th = <count>\nvow_bn_per_th = <TX PER>\n======== Airtime counter test =============\nvow_counter_test = <0/1> 0:dieable, 1:enable\nvow_counter_test_period = <period> ms\nvow_counter_test_band = <band>\nvow_counter_test_avgcnt = <average num> sec\nvow_counter_test_target = <wlanidx>\n======== DVT =============\nvow_dvt_en = <0/1> 0:dieable, 1:enable\nvow_monitor_sta = <STA num>\nvow_show_sta = <STA num>\nvow_monitor_bss = <BSS num>\nvow_monitor_mbss = <MBSS num>\nvow_show_mbss = <MBSS num>\nvow_avg_num = <average num> sec\n======== RED ===========\nvow_set_red_en = <0/1> 0:disable, 1:enable\nvow_set_red_show_sta = <STA num>\nvow_set_red_tar_delay = <tarDelay> us\n======== WATF ===========\nvow_watf_en = <0/1> 0:disable, 1:enable\nvow_watf_q = <level>-<quantum> unit 256us\nvow_watf_add_entry = <level>-<Addr>\nvow_watf_del_entry = <Addr>\n"
...
LAB_00051398:
            ...
            if ((uVar22 & 0x2000) != 0) {
              ...
              iVar15 = is_rsne_pmkid_cache_match
                                  ...
                                  *(undefined1 *)(iVar25 + 0xe4),uVar28,local_b0);
              if ((iVar15 != 0) && (local_b0[0] == -1)) {
                uVar8 = 0x35;
                goto LAB_00051398;
              }
              uVar22 = *(uint *)(iVar25 + 0x17c);
              ...
              if ((((uVar9 & 1) == 0) || ("%s: per %u.\n"[uVar21 * 0x5834 + param_1 + 1] == '\0'))
                ...
                *(byte *)(iVar25 + 0xbfe) = *(byte *)(iVar25 + 0xbfe) & 0xf7;
                ...
                if (((ushort)((ushort)(0xe < bVar20) & uVar2 >> 5) == 0) ||
                  ...
                  local_12c = mt_WrapClientSupportsETxBF(param_1,puVar32 + 0x289);
                }
                else {
                  local_12c = mt_WrapClientSupportsVhtETxBF(param_1,puVar32 + 0x2a4);
                }
                *(undefined1 *)(iVar25 + 0x14b8) = (undefined1)local_12c;
...
LAB_00050f20:
              ...
              *(undefined2 *)(iVar25 + 0xbc) = *(undefined2 *)(iVar25 + 0xbe);
              if (*(char *)(iVar15 + 0x96) != '\0') {
                chip_tx_bf_init(param_1,iVar25,puVar32,local_12c);
              }
...
LAB_0004f74c:
      if ((uVar16 < (byte)"======== Badnode detector =============\nvow_bn_en = <0/1> 0:dieable, 1:enable\nvow_bn_mon_period = <period> ms\nvow_bn_fallback_th = <count>\nvow_bn_per_th = <TX PER>\n======== Airtime counter test =============\nvow_counter_test = <0/1> 0:dieable, 1:enable\nvow_counter_test_period = <period> ms\nvow_counter_test_band = <band>\nvow_counter_test_avgcnt = <average num> sec\nvow_counter_test_target = <wlanidx>\n======== DVT =============\nvow_dvt_en = <0/1> 0:dieable, 1:enable\nvow_monitor_sta = <STA num>\nvow_show_sta = <STA num>\nvow_monitor_bss = <BSS num>\nvow_monitor_mbss = <MBSS num>\nvow_show_mbss = <MBSS num>\nvow_avg_num = <average num> sec\n======== RED ===========\nvow_set_red_en = <0/1> 0:disable, 1:enable\nvow_set_red_show_sta = <STA num>\nvow_set_red_tar_delay = <tarDelay> us\n======== WATF ===========\nvow_watf_en = <0/1> 0:disable, 1:enable\nvow_watf_q = <level>-<quantum> unit 256us\nvow_watf_add_entry = <level>-<Addr>\nvow_watf_del_entry = <Addr>\n"
        ...
        uVar12 = *(undefined4 *)(local_100 + 0x1a3);
        *(undefined4 *)(iVar25 + 0x11ec) = *(undefined4 *)(local_100 + 0x19f);
        *(undefined4 *)(iVar25 + 0x11f0) = uVar12;
      }
      if (((*(uint *)(local_100 + 0x240) & 4) != 0) && ((*(ushort *)(iVar10 + 0x18) & 0x20) != 0)) {
        if (3 < DebugLevel) {
          printk("%s():Peer is VHT capable device!\n","ap_cmm_peer_assoc_req_action");
        }
        memmove((void *)(iVar25 + 0xc84),local_100 + 0x194,0xb);
        if (3 < DebugLevel) {
    ...
    iVar15 = os_alloc_mem(param_1,&local_fc,0x900);
    puVar32 = local_100;
    if (iVar15 != 0) goto LAB_0004efb4;
    if (2 < DebugLevel) {
      printk("%s - Send %s response (Status=%d)...\n","ASSOC","ASSOC",local_104);
    }
    __ZTE_STA_Assoc_Process
              (param_1,4,0,0,local_104 + 200,0,iVar25,"ap_cmm_peer_assoc_req_action",0x7bd);
    local_106 = *(ushort *)("pStaCfg->WpaPassPhrase" + uVar29 * 0x5834 + param_1 + 8);
    local_102 = ~((ushort)~(ushort)(((uint)local_102 << 0x12) >> 0x10) >> 2);
    if ((((*(char *)(iVar10 + 0x3e15) == '\0') || (*(char *)(iVar10 + 0x3e14) != '\0')) &&
        (*(int *)(iVar10 + 0x12e4) != 0)) && ((*(ushort *)(local_100 + 0x12) & 0x10) != 0)) {
      local_106 = local_106 | 0x10;
    }
    local_10b = *local_158;
    if (bVar4) {
      local_10b = 4;
    ...
    if ((bool)(bVar3 | bVar5)) {
      MgtMacHeaderInit(param_1,local_b0,1,0,local_100 + 6,iVar10 + 0x1b,iVar10 + 0x21);
      local_104 = 1;
      MakeOutgoingFrame(local_fc,&local_f8,0x18,local_b0,2,&local_106,2,&local_104,2,&local_102,1,
                        &SupRateIe,1,&local_10b,local_10b,local_158 + 1,0xffffffff);
      MiniportMMRequest(param_1,0,local_fc,local_f8);
      os_free_mem(local_fc);
      MacTableDeleteEntry(param_1,*(undefined2 *)(iVar25 + 0xe0),iVar25 + 0xec);
      puVar32 = local_100;
      if ((bVar5) &&
         (iVar25 = MacTableLookup(param_1,local_100 + 6), puVar32 = local_100, iVar25 != 0)) {
        MacTableDeleteEntry(param_1,*(undefined2 *)(iVar25 + 0xe0),iVar25 + 0xec);
        puVar32 = local_100;
      }
      goto LAB_0004efb4;
    }
    MgtMacHeaderInit(param_1,local_b0,1,0,local_100 + 6,iVar10 + 0x1b,(void *)(iVar10 + 0x21));
    uVar9 = (uint)local_10b;
    pbVar19 = local_158 + 1;
    puVar32 = &SupRateIe;
    puVar31 = &local_102;
    pbVar33 = &local_10b;
    ...
    uVar13 = 1;
    uVar14 = 0xffffffff;
    MakeOutgoingFrame(local_fc,&local_f8,0x18,local_b0,2,&local_106,2,&local_104,2,puVar31,1,
    ...
    if (local_158[0xd] != 0) {
      ...
      if (bVar4) {
        MakeOutgoingFrame(local_fc + local_f8,&local_c8,1,&ExtRateIe,1,local_158 + 0xd,
                          local_158[0xd],local_158 + 0xe,0xffffffff,puVar31,uVar12,puVar32,uVar13,
                          pbVar33,uVar9,pbVar19,uVar14);
        local_f8 = local_f8 + local_c8;
      }
    }
    if (*(char *)(param_1 + 0xa7cbfa) == '\x01') {
      MAP_InsertMapCapIE(param_1,iVar10,local_fc + local_f8,&local_f8);
      MAP_InsertMapZteIE(param_1,iVar10,local_fc + local_f8,&local_f8);
    }
    if (*(char *)(iVar10 + 0xb21) == '\x01') {
      RRM_InsertRRMEnCapIE
                (param_1,iVar10,local_fc + local_f8,&local_f8,*(undefined1 *)(iVar25 + 0xe4));
    }
    if ((*(uint *)(iVar25 + 0xb4) & 1) != 0) {
      local_e0 = local_fc + local_f8;
      iVar15 = build_wmm_cap_ie(param_1,&local_e0);
      local_f8 = local_f8 + iVar15;
    }
    if (local_104 == 0x1e) {
      local_109 = 0x38;
      local_108 = 5;
      local_107 = 3;
      local_c8 = 0x400;
      MakeOutgoingFrame(local_fc + local_f8,&local_f0,1,&local_109,1,&local_108,1,&local_107,4,
                        &local_c8,0xffffffff);
      local_f8 = local_f8 + local_f0;
    }
    if ((((*(uint *)(local_100 + 0x240) & 1) != 0) && ((*(ushort *)(iVar10 + 0x18) & 0x18) != 0)) &&
       (*(char *)(iVar10 + 0x891) != '\0')) {
      local_d8[2] = 0;
      local_e0 = local_fc + local_f8;
      iVar15 = build_ht_ies(param_1,&local_e0);
      local_f8 = iVar15 + local_f8;
      if ((*(int *)(local_100 + 0x260) == 0) || (*(char *)(param_1 + 0xa39fbb) == '\x01')) {
        local_e0 = local_fc + local_f8;
        local_d8[2] = 1;
        iVar15 = build_ht_ies(param_1,&local_e0);
        local_f8 = local_f8 + iVar15;
      ...
      if (((*(uint *)(local_100 + 0x240) & 4) != 0) && ((*(ushort *)(iVar10 + 0x18) & 0x20) != 0)) {
        local_c4 = 1;
        local_c8 = local_fc + local_f8;
        local_c2 = *(undefined1 *)(iVar10 + 0x1a);
        local_c0 = *(ushort *)(iVar10 + 0x18);
        local_b8 = iVar10;
        ...
        txbf_bfee_cap_set(1,((uint)(byte)local_100[0x2a5] << 0x1c) >> 0x1f,local_100[0x2a6] & 7);
        iVar15 = build_vht_ies(param_1,&local_c8);
        local_f8 = local_f8 + iVar15;
    ...
    if ((((uVar9 & 0x18) != 0) && ((*(ushort *)(iVar10 + 0x18) & 0x1c0) != 0)) &&
       (*(char *)(iVar10 + 0x891) != '\0')) {
      iVar15 = add_assoc_rsp_he_ies(iVar10,local_fc,local_f8);
      if (0 < DebugLevel) {
      ...
      if ((((iVar15 == 0) || (iVar15 = wlan_config_get_he_twt_support(iVar10), iVar15 == 0)) ||
          (((local_100[0x19d] & 0x20) == 0 ||
           (((*(uint *)(iVar25 + 0x78) & 2) == 0 || (local_100[0x22e] != -0x28)))))) ||
         (local_100[0x22f] == '\0')) {
        uVar9 = *(uint *)(iVar25 + 100);
      }
      else {
        iVar15 = add_assoc_reassoc_rsp_twt_ie
                           (iVar10,*(undefined2 *)(iVar25 + 0xe0),local_fc + local_f8);
        if (0 < DebugLevel) {
    ...
    iVar15 = build_extended_cap_ie(param_1,&local_e0,uVar12);
    local_f8 = local_f8 + iVar15;
    if ((local_100[0x196] & 8) != 0) {
      *(undefined1 *)(iVar25 + 0x13b4) = 1;
    }
    iVar15 = HcGetBandByWdev(iVar10);
    if (*(int *)(param_1 + (iVar15 + 0xd9e3a) * 4) == 0) {
LAB_0004fe80:
      local_100[0x196] = local_100[0x196] & 0xbf;
    }
    else {
      ...
      local_100[0x196] = local_100[0x196] | 0x40;
    }
    iVar15 = build_vendor_ie(param_1,iVar10,local_fc + local_f8,4);
    local_f8 = local_f8 + iVar15;
    if (*(char *)(iVar25 + 0xd24) != '\0') {
      local_f0 = 0;
      local_107 = 0;
      local_c8 = 0;
      os_alloc_mem(0,&local_f0,0x200);
      if (local_f0 != 0) {
        __memzero(local_f0,0x200);
        WscBuildAssocRespIE(param_1,*(undefined1 *)(iVar25 + 0xe4),0,local_f0,&local_107);
        MakeOutgoingFrame(local_fc + local_f8,&local_c8,local_107,local_f0,0xffffffff);
        local_f8 = local_f8 + local_c8;
        os_free_mem(local_f0);
      }
    }
    MiniportMMRequest(param_1,0,local_fc,local_f8);
    os_free_mem(local_fc);
...
LAB_000500d8:
      puVar32 = local_100;
      if (*(int *)(iVar25 + 8) != 0) {
        if (local_104 != 0) goto LAB_0005010c;
    ...
    if (*(int *)(iVar25 + 0xfc) == 2) {
      ...
      if (local_104 != 0) goto LAB_000500d8;
    }
    ...
    if ((uVar9 & 0x2090) == 0) {
      if ((uVar9 & 0x10040) == 0) {
        ...
        iVar11 = is_rsne_pmkid_cache_match
                           (local_100 + 0x92,local_100[0x191],&DAT_003687fc + param_1,
                            *(undefined1 *)(iVar25 + 0xe4),__src_00,&local_c8);
        if (iVar11 != 0) {
          process_pmkid(param_1,iVar10,iVar25,local_c8);
        }
      }
    }
    else {
      ...
      if (iVar11 == 0) {
LAB_000503cc:
        if ((*(char *)(iVar25 + 0xd24) != '\0') || (local_100[0x191] == '\0')) {
          puVar32 = local_100;
          if (2 < DebugLevel) {
        ...
        store_pmkid_cache_in_sec_config(param_1,iVar25,local_c8);
        if (2 < DebugLevel) {
          printk("ASSOC - CacheIdx = %d\n",local_c8);
          goto LAB_000503cc;
        }
        puVar32 = local_100;
        if ((*(char *)(iVar25 + 0xd24) != '\0') || (local_100[0x191] == '\0')) goto LAB_0004efb4;
      }
...
LAB_0005010c:
  ...
  __ZTE_STA_Assoc_Process
            (param_1,0x13,puVar32 + 6,0,local_104 + 200,0,iVar25,"ap_cmm_peer_assoc_req_action",
             0xc2e);
  puVar32 = local_100;
LAB_0004efc8:
  os_free_mem(puVar32);
