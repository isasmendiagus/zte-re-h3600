// module: mt7915.ko
// function: MtCmdTxBfBackoffCtrl @ 0x1bb6b0
// size: 324 bytes
//

undefined4 MtCmdTxBfBackoffCtrl(int param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  if (0 < DebugLevel) {
    printk("%s: fgTxBFBackoffEn: %d, BandIdx: %d\n","MtCmdTxBfBackoffCtrl",param_2,param_3);
  }
