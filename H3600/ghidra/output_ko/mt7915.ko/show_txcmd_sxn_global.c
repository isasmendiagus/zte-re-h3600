// module: mt7915.ko
// function: show_txcmd_sxn_global @ 0x9a464
// size: 280 bytes
//

undefined4 show_txcmd_sxn_global(undefined4 param_1,char *param_2)

{
  ...
  local_18 = CONCAT31(local_18._1_3_,0x10);
  ...
  uVar4 = 1;
  if (iVar3 != 1) {
    os_zero_mem(local_14[0],0x14);
    *(byte *)local_14[0] = (byte)*local_14[0] & 0xc0 | 0x10;
    *local_14[0] = *local_14[0] & 0xffc0003f | 0x400;
    uVar4 = send_cmd_msg(param_1,&local_18,local_14[0]);
  }
  if (2 < DebugLevel) {
    printk("%s: Ret = %d\n","show_txcmd_sxn_global",uVar4);
  }
  return uVar4;
}
