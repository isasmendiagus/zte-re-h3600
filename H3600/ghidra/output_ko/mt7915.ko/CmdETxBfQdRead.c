// module: mt7915.ko
// function: CmdETxBfQdRead @ 0x1b30a8
// size: 416 bytes
//

undefined4 CmdETxBfQdRead(int *param_1,undefined4 param_2)

{
  ...
  if (iVar2 == 0) {
    ...
    if (2 < DebugLevel) {
      printk("%s: subCarrIdx = %d,  Band:%d\n","CmdETxBfQdRead",param_2,uVar1);
    }
