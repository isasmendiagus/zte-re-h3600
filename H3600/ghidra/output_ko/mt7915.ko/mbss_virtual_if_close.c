// module: mt7915.ko
// function: mbss_virtual_if_close @ 0x52788
// size: 320 bytes
//

undefined4 mbss_virtual_if_close(int param_1)

{
  ...
  uVar2 = RT28xx_MBSS_IdxGet(uVar1,param_1);
  if (-1 < (int)uVar2) {
    ZTE_Bss_Report_Info_Active(uVar1,uVar2 & 0xff,0);
  }
  return 0;
}
