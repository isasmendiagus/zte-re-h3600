// module: mt7915.ko
// function: ShowHeraRuRaInfoProc @ 0x1bdfe4
// size: 496 bytes
//

undefined4 ShowHeraRuRaInfoProc(undefined4 param_1,char *param_2)

{
  ...
  if ((((pcVar2 != (char *)0x0) && (pcVar3 = strsep(&local_44,"-"), pcVar3 != (char *)0x0)) &&
    ...
    uStack_36 = uVar1;
    if ((3 < DebugLevel) && (printk(&_LC0,"ShowHeraRuRaInfoProc"), 3 < DebugLevel)) {
      printk("WCID: %d RuIdx: %d Direction: %d DumpGroup: %d\n",local_3c & 0xffff,local_3c._2_2_,
             local_38,uStack_36);
    }
