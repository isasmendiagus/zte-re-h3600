// module: mt7915.ko
// function: CmdTxBfAwareCtrl @ 0x1b3c98
// size: 284 bytes
//

undefined4 CmdTxBfAwareCtrl(undefined4 param_1,undefined4 param_2)

{
  ...
  local_30 = 0;
  if (2 < DebugLevel) {
    printk("%s: fgBfAwareCtrl = %d\n","CmdTxBfAwareCtrl",param_2);
  }
