// module: mt7915.ko
// function: MtCmdTxPwrShowInfo @ 0x1bba8c
// size: 324 bytes
//

undefined4 MtCmdTxPwrShowInfo(int param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  if (0 < DebugLevel) {
    printk("%s: ucTxPowerInfoCatg: %d, BandIdx: %d \n","MtCmdTxPwrShowInfo",param_2,param_3);
  }
