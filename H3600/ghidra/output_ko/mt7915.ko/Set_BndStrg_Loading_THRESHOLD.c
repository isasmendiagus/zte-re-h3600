// module: mt7915.ko
// function: Set_BndStrg_Loading_THRESHOLD @ 0x9e298
// size: 192 bytes
//

undefined4 Set_BndStrg_Loading_THRESHOLD(int *param_1,undefined4 param_2)

{
  ...
  if (0 < DebugLevel) {
    printk("%s band %u\n","Set_BndStrg_Loading_THRESHOLD",uVar2);
  }
  if (uVar2 < 2) {
    if (param_1[uVar2 * 0x425 + 0xdb24f] != 0) {
      (**(code **)(param_1[uVar2 * 0x425 + 0xdb24f] + 0x48))
                (param_1,param_1 + uVar2 * 0x425 + 0xdae49,uVar1,1);
      return 1;
    }
  }
  return 1;
