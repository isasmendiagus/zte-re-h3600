// module: mt7915.ko
// function: MtCmdLinkTestRxCtrl @ 0x1bd5b8
// size: 308 bytes
//

undefined4 MtCmdLinkTestRxCtrl(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  local_38 = 0;
  if (2 < DebugLevel) {
    printk("%s: ucRxAntIdx: %d, ucBandIdx: %d\n","MtCmdLinkTestRxCtrl",param_2,param_3);
  }
