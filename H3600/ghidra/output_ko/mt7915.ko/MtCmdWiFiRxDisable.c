// module: mt7915.ko
// function: MtCmdWiFiRxDisable @ 0x1af2e8
// size: 288 bytes
//

undefined4 MtCmdWiFiRxDisable(undefined4 param_1)

{
  ...
  local_34 = 0;
  if (3 < DebugLevel) {
    printk("%s: WiFiRxDisable = %d\n","MtCmdWiFiRxDisable",1);
  }
  ...
  if (iVar1 == 0) {
    ...
    local_40 = CONCAT13(6,CONCAT12(0xed,(undefined2)local_40));
