// module: mt7915.ko
// function: CmdTxBfHwEnableStatusUpdate @ 0x1b4110
// size: 296 bytes
//

undefined4 CmdTxBfHwEnableStatusUpdate(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  local_38 = 0;
  if (2 < DebugLevel) {
    printk("%s: fgEBfHwEnable = %d, fgIBfHwEnable = %d\n","CmdTxBfHwEnableStatusUpdate",param_2,
           param_3);
  }
  ...
  if (2 < DebugLevel) {
    printk("%s:(ret = %d)\n","CmdTxBfHwEnableStatusUpdate",uVar2);
  }
  return uVar2;
}
