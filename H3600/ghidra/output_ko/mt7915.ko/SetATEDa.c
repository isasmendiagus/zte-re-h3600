// module: mt7915.ko
// function: SetATEDa @ 0x260f5c
// size: 4 bytes
//

undefined4 SetATEDa(int param_1,char *param_2)
...
LAB_0026074c:
  if (__src != (undefined1 *)0x0) {
    ...
    if (uStack_38 == 6) {
      uStack_34 = 0x140000;
      memmove(&uStack_30,__src,6);
      CmdExtWtblUpdate(param_1,uVar6,2,&uStack_34,0x14);
      if (DebugLevel < 3) {
        return 1;
      }
