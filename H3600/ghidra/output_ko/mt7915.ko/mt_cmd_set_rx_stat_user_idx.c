// module: mt7915.ko
// function: mt_cmd_set_rx_stat_user_idx @ 0x1bed08
// size: 300 bytes
//

undefined4 mt_cmd_set_rx_stat_user_idx(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  local_38 = 0;
  if (0 < DebugLevel) {
    printk("%s(): band_idx: %d, user_idx: 0x%x\n","mt_cmd_set_rx_stat_user_idx",param_2,param_3);
  }
  ...
  if (2 < DebugLevel) {
    printk("%s:(ret = %d)\n","mt_cmd_set_rx_stat_user_idx",uVar2);
  }
  return uVar2;
}
