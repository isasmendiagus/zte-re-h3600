// module: mt7915.ko
// function: wext_send_btm_query_event @ 0x224800
// size: 184 bytes
//

void wext_send_btm_query_event(undefined4 param_1,undefined4 *param_2,void *param_3,size_t param_4)

{
  ...
  if (local_24[0] != (undefined4 *)0x0) {
    ...
    *(size_t *)((int)puVar1 + 10) = param_4;
    ...
    RtmpOSWrielessEventSend(param_1,1,0x929,0,local_24[0],uVar3);
