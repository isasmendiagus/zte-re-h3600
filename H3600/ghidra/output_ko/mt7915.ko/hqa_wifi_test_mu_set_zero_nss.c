// module: mt7915.ko
// function: hqa_wifi_test_mu_set_zero_nss @ 0x9040c
// size: 312 bytes
//

undefined4 hqa_wifi_test_mu_set_zero_nss(undefined4 param_1,undefined4 param_2)

{
  ...
  local_1c = 0;
  if (0 < DebugLevel) {
    printk("%s: zero_nss:%u\n","hqa_wifi_test_mu_set_zero_nss",param_2);
  }
  ...
  if (0 < DebugLevel) {
    printk("%s: Ret=%d\n","hqa_wifi_test_mu_set_zero_nss",uVar2);
  }
  return uVar2;
}
