// module: mt7915.ko
// function: hqa_stop_tx_ext @ 0x2763ac
// size: 240 bytes
//

undefined4 hqa_stop_tx_ext(int param_1,undefined4 param_2,int param_3)

{
  ...
  *(char *)(param_1 + 0xa3ae36) = (char)local_1c;
  (**(code **)(iVar2 + 0x18))(param_1);
  uVar1 = (**(code **)(iVar2 + 0xc))(param_1);
  *(undefined4 *)(param_3 + 0xe) = local_24;
  FUN_0026cdd0(param_3,param_2,6,uVar1);
  if (2 < DebugLevel) {
    printk("%s: band_idx:%u\n","hqa_stop_tx_ext",local_1c);
  }
  return uVar1;
}
