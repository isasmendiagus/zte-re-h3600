// module: mt7915.ko
// function: RTMPIoctlVowGroupMaxRatio @ 0x36c0c
// size: 324 bytes
//

undefined4 RTMPIoctlVowGroupMaxRatio(undefined4 param_1,int param_2,undefined4 param_3)
...
LAB_00036c6c:
      if (*local_2c == 0) {
        ...
        do {
          ...
          set_vow_max_ratio(param_1,acStack_28);
          if (2 < DebugLevel) {
            printk("OID_802_11_VOW_GROUP_MAX_RATIO(0x%08x) -> val %d\n",param_3,
