// module: mt7915.ko
// function: hqa_wifi_test_mu_cal_init_mcs @ 0x8f780
// size: 588 bytes
//

undefined4 hqa_wifi_test_mu_cal_init_mcs(undefined4 param_1,undefined2 *param_2)

{
  ...
  if (param_2 == (undefined2 *)0x0) {
    ...
    uStack_41 = *(undefined1 *)((int)param_2 + 9);
    local_4a = *param_2;
    local_48 = param_2[1];
    local_46 = param_2[2];
    local_44 = *(undefined1 *)(param_2 + 3);
    uStack_43 = *(undefined1 *)((int)param_2 + 7);
    local_42 = *(undefined1 *)(param_2 + 4);
    local_40 = param_2[5];
    local_3e = param_2[6];
    if ((0 < DebugLevel) &&
       (printk("%s: Num_User:%u, BW:%u, Nss[0~3]:%u %u %u %u\n","hqa_wifi_test_mu_cal_init_mcs",
               *(undefined1 *)param_2,*(undefined1 *)((int)param_2 + 1),*(undefined1 *)(param_2 + 1)
               ,*(undefined1 *)((int)param_2 + 3),*(undefined1 *)(param_2 + 2),
               *(undefined1 *)((int)param_2 + 5)), 0 < DebugLevel)) {
  ...
  if (0 < DebugLevel) {
    printk("%s: Ret=%d\n","hqa_wifi_test_mu_cal_init_mcs",uVar2);
  }
  return uVar2;
}
