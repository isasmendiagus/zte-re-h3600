// module: mt7915.ko
// function: hqa_wifi_test_mu_speed_up_lq @ 0x90548
// size: 312 bytes
//

undefined4 hqa_wifi_test_mu_speed_up_lq(undefined4 param_1,undefined4 param_2)

{
  ...
  local_34 = param_2;
  if (0 < DebugLevel) {
    printk("%s: val:%d\n","hqa_wifi_test_mu_speed_up_lq",param_2);
  }
  ...
  if (0 < DebugLevel) {
    printk("%s: Ret=%d\n","hqa_wifi_test_mu_speed_up_lq",uVar2);
  }
  return uVar2;
}
