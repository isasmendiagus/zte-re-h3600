// module: mt7915.ko
// function: MtCmdThermalBasicInfo @ 0x1bc84c
// size: 256 bytes
//

undefined4 MtCmdThermalBasicInfo(undefined4 param_1,undefined1 param_2)

{
  ...
  if (iVar1 == 0) {
    ...
    local_40 = CONCAT13(0x2c,CONCAT12(0xed,(undefined2)local_40));
