// module: mt7915.ko
// function: CmdTxBfeeHwCtrl @ 0x1b438c
// size: 284 bytes
//

undefined4 CmdTxBfeeHwCtrl(undefined4 param_1,undefined4 param_2)

{
  ...
  local_30 = 0;
  if (-1 < DebugLevel) {
    printk("%s: fgTxBfeeHwEnable = %d\n","CmdTxBfeeHwCtrl",param_2);
  }
