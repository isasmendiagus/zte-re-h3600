// module: mt7915.ko
// function: MtAsicInsertRepeaterEntryByFw @ 0x199be8
// size: 300 bytes
//

void MtAsicInsertRepeaterEntryByFw(int param_1,int param_2,undefined4 *param_3)
