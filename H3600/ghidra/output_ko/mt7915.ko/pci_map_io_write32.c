// module: mt7915.ko
// function: pci_map_io_write32 @ 0x1cab9c
// size: 220 bytes
//

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void pci_map_io_write32(undefined4 param_1,int param_2,undefined4 param_3)

{
  ...
  if (iVar4 == 1) {
    if (*(char *)(iVar2 + 0x90) == '\0') {
      ...
      *(undefined4 *)(*(int *)(iVar2 + 0x84) + local_24[0]) = param_3;
      return;
    }
  }
  else {
    ...
    if (*(int *)(iVar2 + 0x1bc) != 0) {
      ...
      (**(code **)(iVar2 + 0x1bc))(param_1,iVar1,param_3);
