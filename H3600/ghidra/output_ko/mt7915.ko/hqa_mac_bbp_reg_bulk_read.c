// module: mt7915.ko
// function: hqa_mac_bbp_reg_bulk_read @ 0x24b2e0
// size: 324 bytes
//

undefined4 hqa_mac_bbp_reg_bulk_read(int param_1,int param_2)

{
  ...
  FUN_002474f4(1,2,local_24,param_1 + 0x1f18);
  __n = (uint)*(ushort *)(param_1 + 0x1f18) * 4;
  iVar1 = sys_ad_alloc_mem(param_1 + 0x1f1c,__n);
  if (iVar1 == 0) {
    if (*(ushort *)(param_1 + 0x1f18) < 0x174) {
      uVar2 = mt_serv_reg_eprm_operation(param_1,2);
      ...
      printk("%s: requested len is longer, make it smaller\n","hqa_mac_bbp_reg_bulk_read");
      FUN_00246b90(param_2,2,0x103);
      uVar2 = 0x103;
    }
  }
  else {
