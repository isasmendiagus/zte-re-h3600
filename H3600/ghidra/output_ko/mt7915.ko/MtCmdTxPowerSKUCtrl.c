// module: mt7915.ko
// function: MtCmdTxPowerSKUCtrl @ 0x1ba738
// size: 324 bytes
//

undefined4 MtCmdTxPowerSKUCtrl(int param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  if (0 < DebugLevel) {
    printk("%s: tx_pwr_sku_en: %d, BandIdx: %d\n","MtCmdTxPowerSKUCtrl",param_2,param_3);
  }
